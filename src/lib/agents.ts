...
export const agents: Agent[] = [
  {
    ...
    title: "BROKER",
    phone: "770-855-3622",
    email: "renae@journeyrealtygroup.net",
    shortBio:
      "Dedicated real estate professional serving the West Georgia and East Alabama area with integrity and expertise.",
  ...
  },
  {
    ...
    title: "REALTOR®",
    phone: "770-713-6099",
    email: "ckilgore1974@gmail.com",
    shortBio:
      "Passionate about connecting clients with their perfect home in West Georgia and East Alabama.",
